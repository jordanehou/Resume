...
function ContactForm({ onSubmit}){
  const [form, setForm] = useState({ first_name: '', last_name:'', city:'', state:'', role:'', email: '', phone:'', image:null});
                    ...
                    <form className="container mt-3 mb-3 form-text" onSubmit={handleSubmit} >
                        ...
                        <Row className="mb-3">
                            <Form.Group controlId="formBasicMobile" className="col col-sm-6">
                                ...
                                <Form.Group controlId="formBasicMobile" className="col col-sm-3">s
                                    <Form.Label>Role</Form.Label>
                                    <Form.Control type="text" name="role" value={form.role} onChange={handleChange} className="form-control" />
                                </Form.Group>
                        </Row>
                        <Row className="mb-3">
                            <Form.Group controlId="formBasicMobile" className="col col-sm-6">
